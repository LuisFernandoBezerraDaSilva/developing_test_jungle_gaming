...
export class GameService {
  ...
  private async resolveUsername(playerId: string): Promise<string> {
    ...
    try {
      ...
      // Username resolution via admin API would require admin token — use playerId as fallback for now
      // In production, use admin client to fetch user info
